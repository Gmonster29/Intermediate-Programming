...
public class Quiz implements GameWriteable {
        ...
        public void play() {
                // Create Categories
                // KAI + GRAHAM + MILES
                Category Sky = new Category("Sky",
                                "You act like a teen girl who loves animals and has a scar, you live in with a shark in water");
                Category TnTina = new Category("TnTina",
                                "You are a quality fortnite boss who loves tnt who lives on a rig");
                Category Brutus = new Category("Brutus",
                                "You are an overweight big fornite boss who lives underground with a minigun. You command the room!");
                Category Meowscles = new Category("Meowscles",
                                "You are a buff cat who lives in his \"catty-corner\" with a shotgun and movement item");
                Category Midas = new Category("Midas",
                ...
                q6.possibleAnswers[1] = new Answer("Relaxing at home with a good book or movie and eating a lot",
                                Brutus);
                ...
                gameIntro();
                // EXTRA CREDIT: KAI -- Made an arraylist then shuffle--questions appear in
...
public boolean isHighScore(String score, String currentHighScore) {
    if (currentHighScore == null || score.compareTo(currentHighScore) > 0) {
        return true;
    }
    return false;
}
